...
curl -L -o BolddesCommonUI.xcframework.zip https://github.com/boomibalanB/BolddeskHome/raw/main/BolddesCommonUI.xcframework.zip
unzip -o BolddesCommonUI.xcframework.zip
CMD

s.vendored_frameworks = [
'BolddeskSample.xcframework',
'BolddeskPlugin.xcframework',
'BolddesCommonUI.xcframework'
]
